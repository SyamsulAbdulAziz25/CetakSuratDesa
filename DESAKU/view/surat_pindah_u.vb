Public Class surat_pindah_u
    ...
    Private Sub TextBox1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextBox4.KeyPress, TextBox16.KeyPress, TextBox15.KeyPress, TextBox1.KeyPress
    ...
    Private Sub TextBox13_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextBox9.KeyPress, TextBox17.KeyPress, TextBox14.KeyPress, TextBox13.KeyPress, TextBox10.KeyPress
