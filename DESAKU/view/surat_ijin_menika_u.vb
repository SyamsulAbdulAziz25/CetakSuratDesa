Public Class surat_ijin_menika_u
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Else
            jk = "Perempuan"
        End If
        DataGridView1.DataSource = lihat.hitung1_ijin_menikah
        Dim row As DataGridViewRow = DataGridView1.CurrentRow
        If (row.Cells(0).Value.ToString <> "0") Then
            DataGridView1.DataSource = lihat.hitung2_ijin_menikah
    ...
    Private Sub TextBox1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextBox6.KeyPress, TextBox3.KeyPress, TextBox2.KeyPress, TextBox1.KeyPress
